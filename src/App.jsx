...
const PRODUCTS = [
  { id: 1, name: 'Canon AE-1', price: '€250.00', img: '/images/c0977b_2a07218a7fec49c381db4db2b388fb12~mv2.jpg' },
  { id: 2, name: 'Canon T50', price: '€100.00', img: '/images/c0977b_e61fb9dec2594919a97cb94e440eb6f3~mv2.jpg' },
  { id: 3, name: 'Praktica Super TL', price: '€150.00', img: '/images/c0977b_6ba1814f97bf4e458cc1aa9f686e0c7e~mv2.jpg' },
  { id: 4, name: 'Minolta Dynax 505 Si', price: '€50.00', img: '/images/c0977b_372b888c834a48f8889d07c19b2cf96d~mv2.jpg' },
]
              ...
              <article key={p.id} className="card">
                ...
                <div className="card__body">
                  ...
                  <div className="card__footer">
                    ...
                    <a
                      href={`mailto:sign2art@gmail.com?subject=Interested in ${p.name}`}
      ...
      <section id="about" className="section">
        <div className="section__inner section__inner--about">
          ...
          <div className="about__text">
            ...
            <p>We also run regular workshops and events — from portrait lighting sessions at our Bochum studio to online community events open to everyone.</p>
            <a href="mailto:sign2art@gmail.com" className="btn btn--gold" style={{ alignSelf: 'flex-start', marginTop: '1rem' }}>Get in Touch</a>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer__inner">
          ...
          <div className="footer__socials">
            <a href="https://www.instagram.com/amgedhigazi" target="_blank" rel="noreferrer" aria-label="Instagram">Instagram</a>
            <a href="https://www.facebook.com/amgad.higazi.10" target="_blank" rel="noreferrer" aria-label="Facebook">Facebook</a>
            <a href="https://www.youtube.com/channel/UCP6GLs7nYFlmAz1juZlUNpA" target="_blank" rel="noreferrer" aria-label="YouTube">YouTube</a>
          </div>
        </div>
      </footer>
